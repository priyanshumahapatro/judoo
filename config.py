...
# Discord App token
bbtoken = "Nzk2Mzc3MzA4MTY0MjU5ODUw.X_XCKg.7z4lzE5K-oWoBNrHADSjk95L6-I" # REMOVE TOKEN BEFORE SYNC!! -Blaze

# YouTube API key (https://console.developers.google.com/apis/credentials/key)
key = "AIzaSyBGazRj-_uCrVRxeULbXWxk-k8gIuq4YNk" # REMOVE KEY BEFORE SYNC!! -Blaze
...
pref = "'" # Command prefix
des = "Judooo's Discord.py Bot" # Description shown on using the help command
